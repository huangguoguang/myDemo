define(['text!module/rule/tpl.html'], function (tpl) {
	var D = {};
        ...
        showDetail: function(e){
            ...
            $.ajax({
				...
				success:function(data) {
					log(data);
					MSG.C('<div class="abstract-title">' + data.center_title + '</div><div class="abstract-box tl"><div>' + data.center_text + '</div></div>','交易规则',{t:'返回',f:function(){MSG.X();}});
